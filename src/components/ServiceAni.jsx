  ...
  const items = [
    {
      ...
      desc: "Restore damaged panels to their original condition with advanced repair methods. From minor creases to heavy impact dents, we deliver a seamless, factory-standard finish.",
      buttons: ["Precision Reshaping", "Seamless Finish", "Impact Repair Expertise"],
      image: "/a5.jpg",
    },
    {
      id: 2,
      tag: "Sharp-Line Correction",
      title: "Crease Removal Service",
      desc: "Eliminate sharp creases and hard-line dents with specialised techniques that restore the panel’s natural curves without fillers or repainting.",
      buttons: ["Paint-Free Restoration", "Precision Metalwork", "Flawless Surface Finish"],
      image: "/a3.jpg",
    },
    {
      id: 3,
      tag: "Paint-Safe Repair",
      title: "Door Ding Repair Service",
      desc: "Remove small door dings and parking lot dents with clean, paint-safe methods. Restores your panel’s shape and smoothness without needing body filler or respray.",
      buttons: ["Parking Dent Removal ", "Precision Access Tools", "Restored Factory Look"],
      image: "/a4.jpg",
    },
    {
      id: 4,
      tag: "Multi-Dent Repair",
      title: "Hail Damage Removal Service",
      desc: "Quickly remove multiple hail dents across the roof, bonnet, and panels using advanced PDR techniques - restoring your vehicle without repainting.",
      buttons: ["Paintless Restoration", "Roof & Bonnet Specialists", "Factory Finish Guaranteed"],
      image: "/a2.jpg",
    },
  ];
  return (
